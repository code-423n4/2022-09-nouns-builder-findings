1. Internal functions only called once can inlined to save gas.
...
2. It cost more gas to itialize variables to zero than let the default value of zero be applied.
